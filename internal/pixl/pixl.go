// Package pixl fires fire-and-forget analytics pixels to the receiver service.
...
// Retries up to maxAttempts times with a short delay. Never blocks. Never surfaces errors.
